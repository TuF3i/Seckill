...
var (
	...
	FlashSaleActive        = Response{Status: 41009, Info: "Flash Sale Is Active, Cannot Modify Items"}
	InsufficientStock      = Response{Status: 41010, Info: "Insufficient Stock"}
	PurchaseLimitExceeded  = Response{Status: 41011, Info: "Purchase Limit Exceeded, Cannot Buy Within 5 Minutes"}
)
